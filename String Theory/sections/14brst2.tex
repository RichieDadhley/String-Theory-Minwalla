...
\bq 
    ...
    \bse 
        \begin{split}
            ...
            & = \frac{T^m(\omega)}{(z-\omega)} - \frac{\cl \p b(\omega) c(\omega)}{(z-\omega)} - \frac{\cl b(\omega)\p c(\omega)\cl}{(z-\omega)} - \frac{\cl b(z)\p c(z)\cl}{(z-\omega)} + \frac{3}{(z-\omega)^3} + ... \\
            & = \frac{1}{(z-\omega)}\Big[ T^m(\omega) + 2\cl \p c(\omega)b(\omega)\cl + \cl c(\omega)\p b(\omega) \cl\Big] + \frac{3}{(z-\omega)^3} + ... \\
            & = \frac{1}{(z-\omega)} \Big[ T^m(\omega) + T^g(\omega) \Big] + \frac{3}{(z-\omega)^3} + ... \\
...
\bse 
    \begin{split}
        ...
        \therefore \qquad  T(z)J_B(\omega) & = \frac{c^m-26}{2(z-\omega)^4}c(\omega) + \frac{1}{(z-\omega)}J_B(\omega) + \frac{1}{(z-\omega)}\p J_B(\omega).
    \end{split}
\ese 
