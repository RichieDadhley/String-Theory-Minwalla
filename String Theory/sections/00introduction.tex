...
% Maybe put a comment about not stressing when stuff is on the worldsheet enough. The worldsheet is not physical so just because something is on there, doesn't mean its on the spacetime (target space)