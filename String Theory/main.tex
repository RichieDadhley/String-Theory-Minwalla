...
\textbf{I am currently very busy with my courses at Durham/courses related to work I'm doing here, and so have not had a great deal of time to continue typing up notes to this course. I do plan on finishing them eventually, but it might be a while before that happens.} \\
...
\input{sections/01action.tex}
\input{sections/02modes.tex}
\input{sections/03d26.tex}
\input{sections/04StateOperatorMap.tex}
\input{sections/05CommutingCharges.tex}
\input{sections/06Virasoro.tex}
\input{sections/07WeylAnomaly.tex}
\input{sections/08FreeBosons.tex}
\input{sections/09Wicks.tex}
\input{sections/10FaddeevPopov.tex}
\input{sections/11sghost.tex}
\input{sections/12ghostcurrent.tex}
\input{sections/13brst.tex}
\input{sections/14brst2.tex}
\input{sections/15brst3.tex}
\input{sections/16noghost.tex}
\input{sections/17reallynoghost.tex}
\input{sections/18superstring.tex}
\input{sections/19superfields.tex}
\input{sections/20superstresstensor.tex}
\input{sections/21superghosts.tex} 
\input{sections/22recap.tex}
\input{sections/23bosonisation.tex}
\input{sections/24compactifiedboson.tex}
%\input{sections/25name.tex}
